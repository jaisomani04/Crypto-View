...
export default function Show() {
  ...
  // if (!store.data || !store.graphData) return <div>Loading...</div>; // Handle loading state
            ...
            <div className="show-graph">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <XAxis dataKey="Date" />{" "}
                  {/* Assuming your data has a "Date" key */}
                  <YAxis />
                  <Tooltip />
                  <Area
                    type="monotone"
                    dataKey="Price" // Assuming your data has a "Price" key
                    stroke="#8884d8"
                    fill="#8884d8"
                  />
                </AreaChart>
